...
\DataTypeTok{int} \NormalTok{main()}
\NormalTok{\{}
  \NormalTok{FILE* if1 = fopen(}\StringTok{"95stl/cpp/randomNumbers1.txt"}\NormalTok{,}\StringTok{"r"}\NormalTok{);}
  \NormalTok{FILE* if2 = fopen(}\StringTok{"95stl/cpp/randomNumbers2.txt"}\NormalTok{,}\StringTok{"r"}\NormalTok{);}
...
\DataTypeTok{int} \NormalTok{main()}
\NormalTok{\{}
  \NormalTok{std::ifstream if1(}\StringTok{"95stl/cpp/randomNumbers1.txt"}\NormalTok{,std::ifstream::in);}
  \NormalTok{std::ifstream if2(}\StringTok{"95stl/cpp/randomNumbers2.txt"}\NormalTok{,std::ifstream::in);}
...
\DataTypeTok{int} \NormalTok{main()}
\NormalTok{\{}
  \NormalTok{std::ifstream ifs(}\StringTok{"95stl/cpp/particleList.txt"}\NormalTok{,std::ifstream::in);}
  \CommentTok{// Read in the data}
